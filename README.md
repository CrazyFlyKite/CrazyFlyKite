...
- **[Argüe](https://github.com/CrazyFlyKite/Argue)** - Android app for tracking "**correct**" and "**incorrect**" points during the discussions 📱
- **[SaveTube](https://github.com/CrazyFlyKite/SaveTube)** - Simple tkinter app for downloading YouTube videos 📥
- **[Robotic Rush](https://github.com/CrazyFlyKite/Robotic-Rush)** - Platformer my friends and I built in **3** days for the **Summer JAM** 🎮
